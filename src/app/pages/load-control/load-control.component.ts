    ...
    changeETLStatus(status: string) {
        if (this.selectedRecords.length > 0) {
            ...
            for (var _i = 0; _i < this.selectedRecords.length; _i++) {
                if (status === 'TRIGGER') {
                    if (
                        (this.selectedRecords[_i].TABLE_STATUS === 'TODO' ||
                            this.selectedRecords[_i].TABLE_STATUS ===
                                'COMPLETE') &&
                        this.selectedRecords[_i].DAG_AVAILABLE_STATUS ===
                            'COMPLETE'
                    ) {
                        records.push({
                    ...
                    if (
                        this.selectedRecords[_i].TABLE_STATUS === 'RUNNING' &&
                        this.selectedRecords[_i].DAG_AVAILABLE_STATUS ===
                            'COMPLETE'
                    ) {
                        records.push({
