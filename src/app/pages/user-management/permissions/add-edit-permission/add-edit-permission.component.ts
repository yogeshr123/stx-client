...
export class AddEditPermissionComponent implements OnInit {
    ...
    submit() {
        ...
        if (this.isNew) {
            const name = this.camelCase(
                'access' + formValues.module + 'Module'
            );
            const isPermissionExist = this.permissions.find(
            ...
            if (!isPermissionExist) {
                ...
                this.permissionsService.addPermission(body).subscribe(
                    (data: any) => {
